# Form implementation generated from reading ui file '/home/ake/GitHub/ksp-mod-analyzer/ksp-mod-analyzer/ui/mainwindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/flying.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.groupBoxUpdate = QtWidgets.QGroupBox(parent=self.centralWidget)
        ...
        self.pushButtonSpacedock = QtWidgets.QPushButton(parent=self.groupBoxUpdate)
        ...
        self.progressBarSpacedock = QtWidgets.QProgressBar(parent=self.groupBoxUpdate)
        ...
        self.pushButtonCurse = QtWidgets.QPushButton(parent=self.groupBoxUpdate)
        ...
        self.progressBarCurse = QtWidgets.QProgressBar(parent=self.groupBoxUpdate)
        ...
        self.pushButtonCKAN = QtWidgets.QPushButton(parent=self.groupBoxUpdate)
        ...
        self.progressBarCKAN = QtWidgets.QProgressBar(parent=self.groupBoxUpdate)
        ...
        self.comboBoxSelectData = QtWidgets.QComboBox(parent=self.groupBoxData)
        font = QtGui.QFont()
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.groupBoxData)
        ...
        self.lineEdit = QtWidgets.QLineEdit(parent=self.groupBoxData)
        ...
        self.labelNumberOfRecords = QtWidgets.QLabel(parent=self.groupBoxData)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.groupBoxData)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout.addWidget(self.label_5)
        self.comboBoxDelimiter = QtWidgets.QComboBox(parent=self.groupBoxData)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBoxDelimiter.sizePolicy().hasHeightForWidth())
        self.comboBoxDelimiter.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButtonExportCSV = QtWidgets.QPushButton(parent=self.groupBoxData)
        ...
        self.tableView = CustomTableView(parent=self.groupBoxData)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(347, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_3.addItem(spacerItem4, 0, 1, 1, 2)
        self.labelKSPModAnalyzer = QtWidgets.QLabel(parent=self.centralWidget)
        ...
        self.labelFlyingKerbal = QtWidgets.QLabel(parent=self.centralWidget)
        ...
        self.labelFlyingKerbal.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.labelFlyingKerbal.setObjectName("labelFlyingKerbal")
        self.gridLayout_3.addWidget(self.labelFlyingKerbal, 0, 3, 1, 1)
        self.groupBoxStatus = QtWidgets.QGroupBox(parent=self.centralWidget)
        ...
        self.label = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.labelLastUpdateSpacedock = QtWidgets.QLabel(parent=self.groupBoxStatus)
        ...
        self.labelSpacedockMods = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.groupBoxStatus)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 1, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.groupBoxStatus)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 3, 0, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.labelCurseMods = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.labelLastUpdateCurse = QtWidgets.QLabel(parent=self.groupBoxStatus)
        ...
        self.labelCKANMods = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.groupBoxStatus)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.groupBoxStatus)
        self.label_7.setObjectName("label_7")
        self.gridLayout_2.addWidget(self.label_7, 5, 0, 1, 1)
        self.labelLastUpdateCKAN = QtWidgets.QLabel(parent=self.groupBoxStatus)
